...
class AuthService extends GetxService {
  ...
  Future<void> _saveUserToPrefs() async {
    ...
    if (firestoreUser.value != null) {
      ...
      await prefs.setString('userFirstname', firestoreUser.value!.userFirstname);
      ...
      await prefs.setStringList('favoriteCars', firestoreUser.value!.favoriteCars.cast<String>());
    }
  }
